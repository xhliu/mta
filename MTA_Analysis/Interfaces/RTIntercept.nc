...
interface RTIntercept {
   ...
   *
   * @param elapse_time		time passed since tx generated from source
   * @return TRUE indicates the packet should be forwarded, FALSE
   * indicates that it should not be forwarded.
   *
   */
  event bool forward(message_t* msg, void* payload, uint8_t len, uint32_t elapse_time);
}
